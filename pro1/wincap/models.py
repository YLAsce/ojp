...
class Contestant(models.Model):
    ...
    coach       = models.CharField(max_length = Const.CONTESTANT_NAME_MAX_LENGTH)
    coach_email = models.EmailField(null = True)
    coach_mobile= models.CharField(max_length = Const.MOBILE_MAX_LENGTH)
    award       = models.CharField(max_length = Const.AWARD_MAX_LENGTH)
